...
/**
 * This is a particularly special instance of scraping, we need to make curl calls with a lot of
 * data. It will also likely break.
 */
public class NodeskcoScrapingExecutor extends ScrapingExecutor {
  @Override
